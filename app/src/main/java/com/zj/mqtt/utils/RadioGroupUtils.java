    ...
    private void addHierarchyChangeListener(ViewGroup parent, boolean isRemove) {
        ...
        if (isRemove){
            if (onHierarchyChangeListener instanceof OnHierarchyChangeProxyListener) {
                parent.setOnHierarchyChangeListener(
                        ((OnHierarchyChangeProxyListener) onHierarchyChangeListener).getOnHierarchyChangeListener());
            } else {
            ...
            if (onHierarchyChangeListener == null) {
                ...
                parent.setOnHierarchyChangeListener(
                        new OnHierarchyChangeProxyListener(onHierarchyChangeListener));
            }
        }
    }
